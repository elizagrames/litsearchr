...
naiveimport <-
  litsearchr::import_results(directory = search_directory,
                             filename = NULL,
                             save_dataset = FALSE)

dedupe_stage1 <-
  litsearchr::remove_duplicates(naiveimport, field = "title", method = "quick")

dedupe_stage2 <-
  litsearchr::remove_duplicates(dedupe_stage1, field = "abstract", method =
                                  "similarity")
...
mysearchterms <-
  list(
    ...
    c("species abundance", "species presence", "species occurrence")
  )
